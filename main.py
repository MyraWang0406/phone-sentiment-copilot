...
# 当前 main.py 所在目录：ZDM+Reddit 根目录
ROOT_DIR = Path(__file__).resolve().parent

# 旧项目的数据目录：Global_Phone_Sentiment（和 netlify-deploy 是并行目录）
GLOBAL_SENTIMENT_DIR = ROOT_DIR / "Global_Phone_Sentiment"
...
app = FastAPI(title="PhoneFeedbackIndex API", version="3.0")
